...
internals.String.prototype.fqdn = function () {

    return this._test('fqdn', undefined, function (value, state, options) {
        var parts = value.split('.'),
            tld = parts.pop();

        var valid = true;

        if (parts.length > 0 && /^([a-z\u00a1-\uffff]{2,}|xn[a-z0-9-]{2,})$/i.test(tld)) {
        ...
        return Errors.create('string.fqdn', { value: value }, state, options);
    });
};
